...
export class deliverScr extends Component {
    constructor(props) {
        super(props);
        this.state = {
    ...
    render() {
        ...
        return (
            <View style={styles.container}>
                ...
                <ImageBackground source={require('../../Images/deliever.png')} style={styles.image}>
                    ...
                    <View style={{
                        ...
                        <Image
                            source={require('../../Images/delivered3.png')} style={{ width: 75, height: 75, marginVertical: 15, resizeMode: "cover" }}>

                        </Image>

                        <Text style={{ fontSize: 24, marginBottom: 30 }}>4. We Deliver</Text>
