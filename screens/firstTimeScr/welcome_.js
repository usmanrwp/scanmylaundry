...
export class welcome_ extends Component {
    constructor(props) {
        super(props);
        this.state = {
        ...
        return (
            <View style={styles.container}>
                ...
                <View style={{ flex: 2.5, backgroundColor: "green" }}>
                    <Image source={require('../../Images/main_1.png')}
                ...
                <View style={{ flex: 1, }}>
                    <Image source={require('../../Images/bottom_1.png')}
                        style={{ width: "100%", height: "100%" }}
                        resizeMode={'contain'}>
                ...
                <View style={{ flex: .8 }}>
                    ...
                    <Image source={require('../../Images/blue_icom.png')}
                        style={{ width: "100%", height: "100%" }}
                        resizeMode={'contain'}>
                ...
                <View style={{ flex: .5,  justifyContent:"center" }}>
                    ...
                    <View style={{ backgroundColor: "transparent", width: "100%", justifyContent: "center" }}>
                        ...
                        <TouchableOpacity onPress={() => this.props.navigation.navigate('cleanScr')}>
                ...
                {/* <ImageBackground source={require('../../Images/welcome1.png')} style={styles.image}
                    resizeMode={'stretch'}>
