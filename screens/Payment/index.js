...
class index extends Component {
  ...
  componentDidMount = async () => {
    ...
    // alert(JSON.stringify(res.PublishKey))
  ...
  paymentBag = async () => {
    ...
    if (this.state.name === '') {
      ...
      // const apiKey = "pk_live_51HZwpPCrjc44byeFNggHAt0o9yzxFnf6F0o7vKQfZDLU8qEfZNcfMe6NuqcS1YGSqHH4oYHzyZpJOlaC9ccfzKD900Zwk6NsN1";
      const apiKey = "pk_test_51HZwpPCrjc44byeF8Ha4274xy9emsmxpjhepJ0QSOxV2e15pK3C7YWY6c6zbhmghq71oKTMsPmHNXi7fEvl5HilW00Aj2Wp9WU";
      const client = new Stripe(apiKey);
      const token = await client.createToken({
        number: this.state.cardNum.replace(/ /g, ''),
        exp_month: e_data.toString().split('/')[0],
        exp_year: e_data.toString().split('/')[1],
  ...
  apiCallPayment = async (tokenid) => {
    ...
    await fetch("https://scanmylaundry.com/api/stripe/make_transaction.php", {
      method: "POST",
      headers: {
        Accept: "application/json",
        "Content-Type": "application/json"
  ...
  //     this.setState({ buttonActive: false, loading: true })
  //     let e_data = this.state.expiryDate;
  //     // alert(this.state.expiryDate);
  //     // alert(e_data.toString().split('/')[0]);
  //     // const apiKey = "sk_test_d0U7pU70OcqI9XOxrtRtQAcW00bjm5Lzy1";
  //     const apiKey = "pk_test_51HZwpPCrjc44byeF8Ha4274xy9emsmxpjhepJ0QSOxV2e15pK3C7YWY6c6zbhmghq71oKTMsPmHNXi7fEvl5HilW00Aj2Wp9WU";
  //     // const apiKey = "pk_live_51HZwpPCrjc44byeFNggHAt0o9yzxFnf6F0o7vKQfZDLU8qEfZNcfMe6NuqcS1YGSqHH4oYHzyZpJOlaC9ccfzKD900Zwk6NsN1";
  //     const client = new Stripe(apiKey);
  //     const token = await client.createToken({
  ...
  //     await fetch("https://essexlaundryapp.com/api/stripe/make_transaction.php", {
  //       method: "POST",
  //       headers: {
  //         Accept: "application/json",
  //         "Content-Type": "application/json"
